                    ...
                    if (response.ok) {
                        ...
                        newMessages.forEach(msg => {
                            if (msg.sender_type === 'admin') {
                                console.log(`📨 Новое сообщение от админа (ID: ${msg.id}): "${msg.message || 'изображение/файл'}"`);
                                ...
                                console.log('🎵 Вызов playNotificationSound() для сообщения от админа');
        ...
        window.handleQuickReply = function(type) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    const responses = {
                        payment: 'Мы принимаем оплату банковской картой. Оплата безопасна и мгновенна! 💳',
